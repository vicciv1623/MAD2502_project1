...
def get_barycentric_coordinates(triangle_coordinates:np.ndarray[np.float64], point_coordinates:np.ndarray[np.float64]) -> np.ndarray:
...
def get_cartesian_coordinates(triangle_coordinates:np.ndarray[np.float64], barycentric_coordinates:np.ndarray[np.float64]) -> np.ndarray[np.float64]:
...
def is_inside_triangle(triangle_coordinates:np.ndarray[np.float64], point_coordinates:np.ndarray[np.float64]) -> bool:
